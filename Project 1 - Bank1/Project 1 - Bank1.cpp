...
sClient ConvertLineToRRecord(string Line, string Seperator = "#//#")
{
	sClient Client;
...
bool ClientExistsByAccountNumber(string AccountNumber , string FileName)
{
	...
	if (MyFile.is_open())
	{
		...
		{
			Client = ConvertLineToRRecord(Line);
...
{
	eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4, eFindClient = 5, eExit = 6
};
